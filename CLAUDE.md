...
Not yet started: `k8s/` manifests, CI workflow, `docs/db-justification.pdf`. Known cosmetic issue: harmless `libgssapi_krb5` load warning in container logs (see "Local Dependencies & Containerization").
